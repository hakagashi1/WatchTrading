...
public class HomeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = new ProductDAO().getTopNewProducts();
        List<Product> listTrending = new ProductDAO().getTopTrendingProducts();
        List<Product> listBest = new ProductDAO().getTopBestSellerProducts(8);
        //b2: set data to jsp
