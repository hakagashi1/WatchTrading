<%-- 
    Document   : Checkout
    Created on : Oct 31, 2021, 3:23:07 PM
    Author     : ZenBook
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-6 form-group p_star">
                                        <input type="text" class="form-control" id="last" name="last" value="${user.last_name}">
                                ...
                                <div class="order_box">
                                    ...
                                    <ul class="list">
                                        ...
                                        <c:forEach items="${listItems}" var="i">
                                            <li><a href="#">${i.getProduct().getName()} x ${i.getQuantity()}<span class="last">$${i.getQuantity() * i.getPrice()}</span></a></li>
                                        </c:forEach>
                                    </ul>
                                    <ul class="list list_2">
                                        <li><a href="#">Subtotal <span>$${subtotal}</span></a></li>
                                        <li><a href="#">Shipping <span>${ship.getType()}: $${ship.getPrice()}</span></a></li>
